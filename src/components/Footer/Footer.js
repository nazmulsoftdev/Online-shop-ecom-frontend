  ...
  return (
    <footer className="mt-16">
      <section className="grid lg:grid-cols-4 grid-cols-2 mb-4 pt-12">
        <div>
          <Logo />
          <h2 className="uppercase mt-3 text-xs  lg:tracking-[3px] tracking-[1px]">
            Online Shop
          </h2>
        </div>
        <div>
        ...
        <div className="text-sm">
          ...
          <span className="flex items-center gap-2 mb-[5px]">
            <HiOutlineMail /> nazmulislamsoftservice@gmail.com
          </span>
          <span className="flex items-center gap-2 mb-[5px]">
            <HiOutlinePhone /> +8801935615775{" "}
          </span>
        </div>
      </section>
      <hr />
      <section className="py-5 flex justify-between">
        <div className="lg:text-md md:text-sm text-xs">
          All rights reserved to Online Shop &copy; {new Date().getFullYear()}
        </div>
