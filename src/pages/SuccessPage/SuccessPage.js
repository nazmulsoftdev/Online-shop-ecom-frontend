  ...
  return (
    <section>
      ...
      <div className="mt-10 bg-white rounded-lg p-10 shadow-lg grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-5 lg:w-[70%] mx-auto relative">
        <div>
          <h2 className="mb-3">
            <b>Buyer</b> : {displayName}
          </h2>
          <h2 className="mb-3">
            <b>Address</b> : Savar,Dhaka
          </h2>
          <h2 className="mb-3">
            <b>Phone</b> : +8801935615775
          </h2>
          <h2 className="mb-3">
            <b>Email</b> : {email}
          </h2>
        ...
        <div>
          ...
          {purchased?.map((item, index) => (
            <div className="my-2" key={index}>
              ...
              <p className="capitalize text-xs text-[#777]">
                Size : M &emsp; Colors : Blue
              </p>
            </div>
          ))}
          ...
          <p className="text-xs">
            Purchased on : {new Date().toLocaleDateString("en-GB")}
          </p>
        </div>
      </div>
      <Link to="/">
        <button className="btn bg-[#0a3d62] w-full text-white normal-case mt-4">
          Back to Shop
        </button>
      </Link>
    </section>
